...
const tokenMint = await createMint(
    connection,
    user,
    user.publicKey, // mint authority (cine o sa poata trimite tranzactiile cu instructiunile de mint)
    null, // nu avem freeze authority (cine poate ingheta contul), deci null
